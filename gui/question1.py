...
class Question1:
    def __init__(self, root, responses=None):
        ...
        # Inicjalizacja słownika na odpowiedzi
        ...
        tk.Label(root, text="3. Proszę wybrać najbardziej adekwatne pochodzenie etniczne:", font=("Arial", 14)).pack(pady=10)
        ...
        tk.Button(button_frame, text="Wstecz", font=("Arial", 14), command=self.previous_window).pack(side="left", padx=10)
    ...
    def next_question(self):
        ...
        root = tk.Tk()
        app = Question2(root, self.responses)
        root.mainloop()
